        ...
        <section id="enroll">
            <div class="container">
                <form class="w-50 my-0 mx-auto" action="/cours" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="cost" class="form-label">Стоимсость курса</label>
        ...
        <section id="enroll">
            <div class="container">
                <form class="w-50 my-0 mx-auto" action="/category" method="POST">
                    @csrf
                    <h2 class="m-3">Создать категорию курса</h2>
                    <div class="mb-3">
                        <label for="title" class="form-label">Название категории курса:</label>
                        <input type="text" class="form-control" id="title" name="title">
                        @error('title')
                            <div class="alert alert-danger mt-1" role="alert">
                                {{ $message }}
